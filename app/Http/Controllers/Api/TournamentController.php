    ...
    public function index(Request $request)
    {
        ...
        try {
            ...
            if ($request->has('my_tournaments') && $request->my_tournaments) {
                ...
                // Apply proper location filtering
                \Log::info('Applying location filtering for tournaments');
    ...
    private function applyLocationFilter($query, $user)
    {
        ...
        $query->where(function ($q) use ($user, $userCommunity, $userCounty, $userRegion) {
            ...
            if ($userCommunity) {
                ...
                \Log::info('Added community filter', [
            ...
            if ($userRegion) {
                ...
                \Log::info('Added regional filter', [
