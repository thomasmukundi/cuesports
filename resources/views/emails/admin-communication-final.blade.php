...
@section('content')
    ...
    <div style="background-color: #f8f9fa; padding: 25px; border-radius: 8px; margin: 25px 0; border-left: 4px solid #6366f1;">
        <h3 style="margin-top: 0; color: #374151; font-size: 20px;">{{ $email_subject }}</h3>
        <div style="line-height: 1.8; color: #4b5563; font-size: 16px;">
